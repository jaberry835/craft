...
import { initMsalAuthProvider, invalidateMsalProviderCache } from './msalAuthProvider';
import { setCopilotCliSecretStorage } from './copilotCliSecrets';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    initMsalAuthProvider(context.secrets, (msg) => log(msg));
    setCopilotCliSecretStorage(context.secrets);
    ...
    context.subscriptions.push(
        vscode.workspace.onDidChangeConfiguration((event) => {
            ...
            if (event.affectsConfiguration('junior.msal')) {
