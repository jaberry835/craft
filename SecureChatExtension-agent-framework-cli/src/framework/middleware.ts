...
export interface ChatMiddleware {
    ...
    /** Optional streaming variant. Wraps getResponseStream() calls when implemented. */
    processStream?(context: ChatContext, next: () => AsyncGenerator<ChatStreamChunk>): AsyncGenerator<ChatStreamChunk>;
}
