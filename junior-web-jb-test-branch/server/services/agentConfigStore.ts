...
import type { AgentConnection, AgentConnectionSaveRequest, AgentConnectionStatus, AgentCreateRequest, AgentDefinition, AgentModelConnection, AgentModelConnectionStatus, AgentTemplateDefinition, AgentUpdateRequest, AzureAiSearchConnectionDefinition, McpCatalogEntry, McpCustomHeader, McpServerDefinition, McpServerSaveRequest, McpServerStatus, ResolvedMcpServerDefinition, WorkspaceSummary, WorkspaceTemplateDefinition } from '../types.js';
...
export class AgentConfigStore {
  ...
  async load(): Promise<void> {
    const [agentsJson, connectionsJson, mcpServersJson, agentTemplatesJson, mcpCatalogJson, workspaceTemplatesJson] = await Promise.all([
  ...
  async updateAgent(agentId: string, update: AgentUpdateRequest): Promise<AgentDefinition> {
    ...
    const next: AgentDefinition = {
      ...
      reasoningEffort: update.reasoningEffort ?? current.reasoningEffort ?? 'medium',
